...
SDL_DYNAPI_PROC(int,SDL_TestTaskbar,(void),(),return)
SDL_DYNAPI_PROC(SDL_Taskbar *,SDL_CreateTaskbar,(void),(),return)
SDL_DYNAPI_PROC(SDL_bool,SDL_SetTaskbarState,(SDL_Window *a, const SDL_Taskbar *b, const SDL_TaskbarState c),(a,b,c),return)
SDL_DYNAPI_PROC(SDL_bool,SDL_SetTaskbarProgressValue,(SDL_Window *a, const SDL_Taskbar *b, const float c),(a,b,c),return)
SDL_DYNAPI_PROC(void,SDL_DestroyTaskbar,(SDL_Taskbar *a),(a),return)
